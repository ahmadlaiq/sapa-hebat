...
class BermasyarakatScreen extends StatefulWidget {
  final int userId;
  final bool isFlowMode;
  final VoidCallback? onNext;
  final VoidCallback? onBack;

  const BermasyarakatScreen({
    super.key,
  ...
  @override
  State<BermasyarakatScreen> createState() => _BermasyarakatScreenState();
}

class _BermasyarakatScreenState extends State<BermasyarakatScreen> {
  final TextEditingController _notesController = TextEditingController();
  final Map<String, bool> _checklistItems = {
    'Menyapa Tetangga': false,
    'Membantu Orang Tua': false,
    'Kerja Bakti': false,
    'Berkunjung ke Teman': false,
    'Bersosialisasi': false,
  };
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Bermasyarakat'),
