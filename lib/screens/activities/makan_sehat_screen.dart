...
class MakanSehatScreen extends StatefulWidget {
  final int userId;
  final bool isFlowMode;
  final VoidCallback? onNext;
  final VoidCallback? onBack;

  const MakanSehatScreen({
    super.key,
  ...
  @override
  State<MakanSehatScreen> createState() => _MakanSehatScreenState();
}

class _MakanSehatScreenState extends State<MakanSehatScreen> {
  final TextEditingController _notesController = TextEditingController();
  final Map<String, bool> _checklistItems = {
    'Sarapan Pagi': false,
    'Makan Buah': false,
    'Makan Sayur': false,
    'Minum Air Putih 8 Gelas': false,
    'Makan Siang': false,
    'Makan Malam': false,
    'Hindari Junk Food': false,
  };
          ...
          children: [
            ...
            TextField(
              ...
              decoration: const InputDecoration(
                labelText: 'Catatan Menu Makanan',
